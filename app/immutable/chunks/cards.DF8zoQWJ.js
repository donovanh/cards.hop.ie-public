import{a as p,t as x}from"./disclose-version.C30CovIo.js";import"./legacy.JNgZq3j4.js";import{h as Z,i as Vt,p as ut,S as s,a as vt,aL as $t,a8 as v,a9 as h,a2 as o,ar as u,O as J,a6 as G,aa as H,n as It}from"./runtime.Clv2h664.js";import{d as Ot,s as Gt,g as Bt,a as X,b as Y,h as C}from"./preload-helper.lpx_onmw.js";import{h as qt}from"./html.Dp2mR9o_.js";import{p as Q,t as zt,s as V,a as Et}from"./index.BVrLjc9O.js";import{p as I}from"./proxy.C7zZTWEY.js";import{p as B,b as tt}from"./props.BoxkulLT.js";import{c as ft,a as P,p as Nt}from"./cardIsOpen.tukbtC6n.js";import{o as et,a as Dt}from"./index-client.B8Jf1U8c.js";import{m as Mt}from"./metadata.lrNKgLnS.js";import{i as kt}from"./lifecycle.Bb7xKLtc.js";function Lt(t,e,n,r,a){var y;Z&&Vt();var F=(y=e.$$slots)==null?void 0:y[n],d=!1;F===!0&&(F=e.children,d=!0),F===void 0||F(t,d?()=>r:r)}function Ht(t,e,n){var r=t.__className,a=Xt(e);Z&&t.className===a?t.__className=a:(r!==a||Z&&t.className!==a)&&(e==null&&!n?t.removeAttribute("class"):t.className=a,t.__className=a)}function Xt(t,e){return(t??"")+""}function Yt(t,e,n){{if(t.classList.contains(e))return;t.classList.add(e)}}var Pt=x("<div><!></div>");function At(t,e){ut(e,!1);let n=B(e,"root",8,null),r=B(e,"rootMargin",8,"300px"),a=B(e,"threshold",8,.01),F=B(e,"once",8,!1),d=B(e,"intersecting",12,!1),y=$t(null),f;et(()=>{f=new IntersectionObserver(([_])=>{d(_.isIntersecting),d()&&F()&&f.disconnect()},{root:n(),rootMargin:r(),threshold:a()}),s(y)&&f.observe(s(y))}),Dt(()=>{f==null||f.disconnect()}),kt();var g=Pt(),K=v(g);Lt(K,e,"default",{get intersecting(){return d()}}),h(g),tt(g,_=>o(y,_),()=>s(y)),p(t,g),vt()}var Rt=x('<button><div class="back svelte-e4ye0q"><div class="content svelte-e4ye0q"><p class="intro svelte-e4ye0q"> </p> <p class="main-content svelte-e4ye0q"> </p> <p class="sign-off svelte-e4ye0q"> </p></div></div> <div class="front svelte-e4ye0q"><div class="hardcoded-front-content svelte-e4ye0q"><!></div> <div class="content svelte-e4ye0q"><p class="svelte-e4ye0q"> </p></div></div> <div class="lining svelte-e4ye0q"></div></button>'),Ut=x("<div><!></div>");function i(t,e){ut(e,!0);const n=Gt(),r=()=>X(P,"$cardIsOpen",n),a=()=>X(ft,"$cardText",n),F=()=>X(Et,"$i18n",n),d=()=>X(zt,"$t",n),{decompressFromEncodedURIComponent:y}=Nt;let f="closed",g="open";const K=Q.url.pathname.includes("edit"),_=Q.url.pathname.includes("view"),ht=!K&&!_,A=K?"edit":_?"view":"preview",nt=e.cardClass.split(" ")[0],{isWide:mt,defaultText:at,hardcodedFrontText:st}=Mt[nt];let q=u(!1),S=u(I(K&&r()?g:f));J(()=>{K?r()?o(S,g):o(S,f):s(q)?o(S,g):o(S,f)});let m=u(I(K||ht?a():at));J(()=>{o(m,I(K?a():at))});function pt(){r()?(P.updateCardIsOpen(!1),o(q,!1)):(o(E,0),o(N,0),P.updateCardIsOpen(!0),o(q,!0))}function xt(){A==="preview"&&(o(S,f),P.updateCardIsOpen(!1),o(q,!1))}let z=u(null),R=u(null),E=u(0),N=u(0),rt=u(0),ot=u(0),yt=I(_?.5:0);function it(c){if(s(R))if(s(S)===f&&A==="view"){const{innerWidth:T,innerHeight:l}=window,b=c.clientX/T*2-1,w=c.clientY/l*2-1;o(E,b*10),o(N,w*-10),ct(b,w)}else o(E,0),o(N,0),ct(-400,-400)}function ct(c,T){if(!s(z))return;const l=s(z).getBoundingClientRect();o(rt,1-c*(l.right-l.left)),o(ot,1-T*(l.bottom-l.top))}function Tt(){const c=Q.url.searchParams.get("data")||"",T=y(c),l=decodeURIComponent;if(!T)return;const[b,w,$,U]=T.split("|").map(l);return{frontText:b==="null"?null:b,innerText1:w,innerText2:$,innerText3:U}}let bt=u(!1);et(()=>o(bt,!0)),et(()=>{if(_){const c=Tt();c&&(o(m,I(c)),ft.updateText(s(m)))}return window.addEventListener("mousemove",it),()=>{window.removeEventListener("mousemove",it)}});const Ft=c=>c?c.split("").map(T=>`<span>${T}</span>`).join(""):"";let lt=u("");J(()=>{s(D)&&o(lt,`/images/cards/${nt}.webp`)});let D=u(!1);var M=Ut(),gt=v(M);At(gt,{once:!0,get intersecting(){return s(D)},set intersecting(c){o(D,I(c))},children:(c,T)=>{var l=Rt();l.__click=pt;var b=v(l),w=v(b),$=v(w),U=v($,!0);G(()=>Y(U,s(m).innerText1?d()(s(m).innerText1):"")),h($);var O=H($,2),Kt=v(O,!0);G(()=>Y(Kt,s(m).innerText2?d()(s(m).innerText2):"")),h(O);var W=H(O,2),_t=v(W,!0);G(()=>Y(_t,s(m).innerText3?d()(s(m).innerText3):"")),h(W),h(w),h(b);var k=H(b,2),L=v(k),Ct=v(L);qt(Ct,()=>st&&Ft(d()(st))),h(L);var dt=H(L,2),j=v(dt),St=v(j,!0);G(()=>Y(St,s(m).frontText?d()(s(m).frontText):"")),h(j),h(dt),h(k),It(2),h(l),tt(l,wt=>o(R,wt),()=>s(R)),G(()=>{V(l,"style",`transform: rotateY(${s(E)??""}deg) rotateX(${s(N)??""}deg); opacity: ${(s(D)?1:0)??""}`),Ht(l,`card ${s(S)??""} ${F().language??""} ${e.cardClass??""} ${A??""} ${(mt?"wide":"tall")??""} svelte-e4ye0q`),V($,"style",`font-family: ${e.fonts.innerText1Font??""}`),V(O,"style",`font-family: ${e.fonts.innerText2Font??""}`),V(W,"style",`font-family: ${e.fonts.innerText3Font??""}`),V(k,"style",`--sheenX: ${s(rt)??""}px; --sheenY: ${s(ot)??""}px; --sheenOpacity: ${yt??""}; background-image: url(${s(lt)??""});`),Yt(k,"loaded"),V(L,"style",`font-family: ${e.fonts.frontTextFont??""}`),V(j,"style",`font-family: ${e.fonts.frontTextFont??""}`)}),Bt("mouseleave",l,xt),p(c,l)},$$slots:{default:!0}}),h(M),tt(M,c=>o(z,c),()=>s(z)),p(t,M),vt()}Ot(["click"]);function Wt(t){i(t,{fonts:{frontTextFont:'"Great Vibes", cursive',innerText1Font:'"Kaushan Script", cursive',innerText2Font:'"Great Vibes", cursive',innerText3Font:'"Kaushan Script", cursive'},cardClass:"valentines009"})}function jt(t){i(t,{fonts:{frontTextFont:"Kalam, cursive",innerText1Font:"Kalam, cursive",innerText2Font:'"Kaushan Script", cursive',innerText3Font:"Kalam, cursive"},cardClass:"valentines008"})}function Jt(t){i(t,{fonts:{frontTextFont:"Kalam, cursive",innerText1Font:"Kalam, cursive",innerText2Font:'"Kaushan Script", cursive',innerText3Font:"Kalam, cursive"},cardClass:"valentines007"})}function Qt(t){i(t,{fonts:{frontTextFont:'"Great Vibes", cursive',innerText1Font:'"Kaushan Script", cursive',innerText2Font:'"Great Vibes", cursive',innerText3Font:'"Kaushan Script", cursive'},cardClass:"valentines006"})}var Zt=x(`<style>.valentines005 .hardcoded-front-content {
      color: #111;
      font-weight: bold;
      line-height: 1.25em;
      top: 0.4em;
